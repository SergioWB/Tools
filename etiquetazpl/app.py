...
def out_zpl_label(so_name, ubicacion, team, carrier, order_lines_list, almacen, labels_number, create_date):
    try:
        ...
        for page in range(1, labels_number + 1):
            ...
            zpl_code += f"""
                ^CF0,30
                ^FO90,1550^FDPágina {page}/{labels_number}^FS
                ^CF0,190
                ^FO470,1095^FDAG^FS
                ^XZ
            """
...
def recupera_meli_token(user_id):
    try:
        ...
        if user_id == 25523702:  # Usuario de SOMOS REYES VENTAS
            token_dir = '/home/sergio/servidor-Tlalne/meli/tokens_meli.txt'   # '/home/ubuntu/Documents/server-Tln/Tools/meli/tokens_meli.txt'
        elif user_id == 160190870:  # Usuario de SOMOS REYES OFICIALES
            token_dir = '/home/sergio/servidor-Tlalne/meli/tokens_meli_oficiales.txt'   # '/home/ubuntu/Documents/server-Tln/Tools/meli/tokens_meli_oficiales.txt'
        elif user_id == 1029905409:  # Usuario de SKYBRANDS
            token_dir = '/home/sergio/servidor-Tlalne/meli/tokens_meli_skyBrands.txt'  # '/home/ubuntu/Documents/server-Tln/Tools/meli/tokens_meli_skyBrands.txt'
